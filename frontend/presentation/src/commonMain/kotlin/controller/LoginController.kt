...
class LoginControllerImpl(private val dependencies: Dependencies) : LoginController {
    ...
    override fun onViewCreated(
        ...
        bind(viewLifecycle, BinderLifecycleMode.START_STOP) {
            ...
            loginStore.labels.mapNotNull(loginLabelToOutput) bindTo dependencies.loginOutput
        }
    }
}
