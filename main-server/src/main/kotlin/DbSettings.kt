...
object ResearchVos : Table(name = RESEARCH_TABLE) {
  ...
  val accessionNumber_base: Column<String> = varchar(name = ACCESSION_NUMBER_BASE_FIELD, length = 200)
  val accessionNumber_lastDigit: Column<String> = varchar(name = ACCESSION_NUMBER_LAST_DIGIT_FIELD, length = 200)
